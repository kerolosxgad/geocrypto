...
function showError(error){ 
	switch(error.code) { 
		...
		case error.POSITION_UNAVAILABLE: 
			alert("Positioning failed, location information is not available"); 
		break; 
		...
		case error.UNKNOWN_ERROR: 
			alert("The positioning failed, the positioning system failed"); 
		break; 
	} 
} 
